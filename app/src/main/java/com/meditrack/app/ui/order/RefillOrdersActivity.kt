...
import com.meditrack.app.databinding.ActivityRefillOrdersBinding
        ...
        adapter = OrderAdapter(
            ...
            onReturn = { order ->
                AlertDialog.Builder(this)
                    ...
                    .setMessage("Request return and refund for ${order.medicineName}?")
                    .setPositiveButton("Request Return") { _, _ ->
                        viewModel.returnDeliveredOrder(order)
                    }
                    .setNegativeButton("Keep", null)
                    .show()
            },
