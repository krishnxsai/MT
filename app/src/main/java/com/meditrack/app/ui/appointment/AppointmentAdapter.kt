...
class AppointmentAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val (bgColor, textColor) = when (appt.status) {
            AppointmentStatus.PENDING -> R.color.warning_surface to R.color.warning
            AppointmentStatus.CONFIRMED -> R.color.success_container to R.color.success
            AppointmentStatus.REJECTED -> R.color.error_container to R.color.error
            AppointmentStatus.CANCELLED -> R.color.surface_dim to R.color.text_tertiary
            AppointmentStatus.COMPLETED -> R.color.info_surface to R.color.info
        }
