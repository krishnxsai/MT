...
import com.example.meditrack.data.model.TransactionType
import com.example.meditrack.databinding.ActivityTransactionHistoryBinding
import com.example.meditrack.databinding.ItemTransactionBinding
...
class TransactionHistoryActivity : AppCompatActivity() {
    ...
    private fun observeViewModel() {
        ...
        viewModel.revenueSummary.observe(this) { stats ->
            binding.totalRevenueText.text = String.format("$%,.2f", stats["totalRevenue"] ?: 0.0)
            binding.todayRevenueText.text = String.format("$%,.2f", stats["todayRevenue"] ?: 0.0)
    ...
    class TransactionAdapter : ListAdapter<OrderTransaction, TransactionAdapter.ViewHolder>(DiffCallback()) {
        ...
        class ViewHolder(
            ...
            fun bind(txn: OrderTransaction) {
                ...
                binding.amountText.text = String.format("$%,.2f", txn.amount)
