...
import com.example.meditrack.databinding.ActivityAppointmentsListBinding
...
class AppointmentsListActivity : AppCompatActivity() {
    ...
    private fun handleResult(result: Resource<List<com.example.meditrack.data.model.Appointment>>) {
        when (result) {
            is Resource.Loading -> {
