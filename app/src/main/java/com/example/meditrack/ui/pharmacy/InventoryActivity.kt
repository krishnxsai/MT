...
import com.example.meditrack.databinding.ActivityInventoryBinding
import com.example.meditrack.databinding.DialogAddInventoryBinding
    ...
    class InventoryAdapter(
        ...
        inner class ViewHolder(
            ...
            fun bind(item: InventoryItem) {
                ...
                // Price chip
                binding.priceChip.text = String.format("$%.2f", item.unitPrice)
